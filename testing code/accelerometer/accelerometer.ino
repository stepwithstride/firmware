...
{
  Serial.begin(9600);
  delay(2000); //just for seeing the message (b/c otherwise by the time you open serial the message is gone)
  Serial.println("MMA8452 Basic Example");

  Wire.begin(); //Join the bus as a master
  Serial.println("Mission WIRE COMPLETE!");
...
void initMMA8452() {
  Serial.println("c the accel yet?");
